...
return array(
	 ...
	 */
	'translator' => 'xxx Translator <xxx@translations.colm>',
	...
	/**
	 * Sync: A flag that determines if the laravel built-in locale must 
	 * be changed when you call Gettext::setLocale.
	 */
	'sync' => true,
